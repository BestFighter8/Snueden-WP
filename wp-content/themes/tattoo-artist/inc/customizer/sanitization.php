 ...
 */
function tattooartist_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function tattooartist_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function tattooartist_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function tattooartist_sanitize_float( $input ) {
 ...
 */
function tattooartist_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function tattooartist_sanitize_html( $html ) {
 ...
 */
function tattooartist_sanitize_image( $image, $setting ) {
 ...
 */
function tattooartist_sanitize_nohtml( $nohtml ) {
 ...
 */
function tattooartist_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function tattooartist_sanitize_range_value( $number, $setting ) {
 ...
 */
function tattooartist_sanitize_select( $input, $setting ) {
 ...
 */
function tattooartist_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function tattooartist_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function tattooartist_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
