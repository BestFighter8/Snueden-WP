<?php
/**
 * Header file for the Tattoo Artist theme.
 *
...
<?php wp_body_open(); ?>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'tattoo-artist' ); ?></a>
	
	<?php 
		get_template_part('template-parts/sections/section','header'); 
		
		if ( !is_page_template( 'templates/template-frontpage.php' ) ) {
			tattooartist_breadcrumbs_style();  
		}
	?>
